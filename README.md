...
The sequences from Illumina were pre-processed by removing the primers and then processed using the DADA2 pipeline ([DADA2_pipeline.Rmd]. The resulting object from this processing is dada2multithreads.
